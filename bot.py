...
TOKEN = "7829538203:AAG8zwX8XQJlvJPtEUMmCBXnCRQkYXd4kug"
...
def handle_tiktok_link(message, url):
    try:
        params = {'url': url}
        response = requests.get(API_URL, params=params, timeout=10).json()  # thêm timeout
